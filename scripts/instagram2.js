// ==UserScript==
// @name         IGCleaner
// @version      2026-06-13-v42
// @description  Trying to make my Instagram experience tolerable. v42: hide merged Search/Explore nav button; keep suggested cleanup surgical.
        ...
        for (const mutation of mutationsList) {
            try {
                mutation.addedNodes && mutation.addedNodes.forEach(node => {
                    if (node && node.nodeType === 1) hideAllIGSuggestedLabelsV40(node);
                });
            } catch {}
        }
